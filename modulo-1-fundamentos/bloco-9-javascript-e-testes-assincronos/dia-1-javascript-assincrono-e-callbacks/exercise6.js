// o robô Curiosity tem uma taxa de sucesso de envio de mensagem de 60% 
...
const sendMarsTemperature = (onSucess, onFail) => {
   // const error = handleError();
    ...
    if (probability >= 0.6) {
        ...
        setTimeout(() => onFail(error), messageDelay());
    }
}
...
// resolução do gabarito está diferente da minha... conferir:
/* 
const messageDelay = () => Math.floor(Math.random() * 5000);
